Pod::Spec.new do |s|
  ...
  s.source_files = ['MHDismissModalView/UINavigationController+MHDismissModalView.m', 'MHDismissModalView/UINavigationController+MHDismissModalView.h', 'MHDismissModalView/UIImage+ImageEffects.h', 'MHDismissModalView/UIImage+ImageEffects.m']
